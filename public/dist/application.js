...
var ApplicationConfiguration = function () {
    ...
    var applicationModuleName = 'halp';
...
angular.module('core').controller('DemoStreamController', [
  '$scope',
  function ($scope) {
    var loadCount = 0;
    ...
    function start() {
      easyrtc.connect('gavy', connectSuccess, connectFailure);  /*easyrtc.setOnCall( function(easyrtcid, slot) {
...
angular.module('core').controller('DemoTransmitController', [
  '$scope',
  function ($scope) {
    var loadCount = 0;
    var loadScript = function (file) {
...
angular.module('core').controller('StreamTestController', [
  '$scope',
  function ($scope) {
    var loadCount = 0;
    var loadScript = function (file) {
...
function appInit() {
  ...
  easyrtc.easyApp('easyrtc.multiparty', 'box0', [
    'box1',
    'box2',
    'box3'
  ], loginSuccess);
